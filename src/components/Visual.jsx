    ...
    <>
      <div className="visual">
        ...
        <div className="absolute left-2/4 top-1/4 translate-x-[-50%]  text-center z-50">
          <p style={{ fontFamily: "var(--eng2)" }} className="text-white mobile:text-3xl tablet:text-5xl font-bold ">
            Beauty of Discover
          </p>
          <b
            style={{ fontFamily: "var(--eng1)" }}
            className=" mobile:text-5xl tablet:text-7xl block pt-3 text-white whitespace-nowrap"
          >
            Enjoy Your Dream
            <br />
            Vacation
